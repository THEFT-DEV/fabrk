...
description: 'How Fabrk''s mode object provides consistent, theme-aware styling across all 60+ components. One import, perfect theming.'
...
all 60 UI components use the mode object internally:
