...
/**
  ...
  /**
   * `prisma.aICostEvent`: Exposes CRUD operations for the **AICostEvent** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more AICostEvents
    * const aICostEvents = await prisma.aICostEvent.findMany()
    * ```
    */
  get aICostEvent(): Prisma.AICostEventDelegate<ExtArgs, { omit: OmitOpts }>;
}
