...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'border-input relative flex h-8 w-8 items-center justify-center border text-xs transition-all',
        mode.radius,
        mode.font,
...
export { InputOTP, InputOTP as InputOtp, InputOTPGroup, InputOTPSeparator, InputOTPSlot };
