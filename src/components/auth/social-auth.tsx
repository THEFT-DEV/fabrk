 ...
 * Reusable OAuth buttons and divider for auth forms
 */
...
export const defaultSocialProviders: SocialProvider[] = [
  {
    id: 'github',
    name: 'GitHub',
...
export function SocialAuthDivider({ label = 'Or continue with' }: SocialAuthDividerProps) {
  return (
...
export function AuthErrorMessage({ error }: ErrorMessageProps) {
  return (
    <div
      className={cn(
