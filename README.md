...
A: Correct. $299 × 5 seats. Contact support@fabrk.dev for volume pricing (10+ seats).
...
A: Community support via GitHub Discussions. Paid consulting available (email support@fabrk.dev).
