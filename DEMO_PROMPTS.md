...
Now use the MCP to generate a landing page for an analytics SaaS called "Acme Analytics". Write it to src/app/(public)/page.tsx with hero, features, and CTA sections. Then run npm run dev.
